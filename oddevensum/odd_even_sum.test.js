...
test("odd sum for number 87654321 is 20", () => {
    expect(oddEvenSum(87654321)[0]).toEqual(20);
});

test("even sum for number 87654321 is 16", () => {
    expect(oddEvenSum(87654321)[1]).toEqual(16);
});

test("odd sum for number 100 is 1", () => {
    expect(oddEvenSum(100)[0]).toEqual(1);
});

test("even sum for number 100 is 0", () => {
    expect(oddEvenSum(100)[1]).toEqual(0);
});
